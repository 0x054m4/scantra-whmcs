 ...
 * @return array
 */
function scantra_phishing_detection_config()
{
    return [
        // Display name for your module
        'name' => 'Scantra Phishing Detection',
        // Description displayed within the admin interface
        'description' => 'Automated phishing detection and domain management with Scantra API integration.',
        // Module author name
        'author' => 'Scantra',
        // Default language
        'language' => 'english',
        ...
        'version' => '1.0',
        'fields' => [
            // API Token for Scantra authentication
            'API Token' => [
                'FriendlyName' => 'API Token',
                'Type' => 'password',
                'Size' => '50',
                'Default' => '',
                'Description' => 'Enter your Scantra API token',
            ],
            // Enable domain tracking (add/delete)
            'Enable Domain Tracking' => [
                'FriendlyName' => 'Enable Domain Tracking',
                'Type' => 'yesno',
                'Description' => 'Automatically add and delete domains for phishing detection',
            ],
            // Auto suspend domains when incident occurs
            'Auto Suspend Domains' => [
                'FriendlyName' => 'Auto Suspend Domains',
                'Type' => 'yesno',
                'Description' => 'Automatically suspend domains when phishing incidents are detected',
            ],
            // Create support tickets for incidents
            'Create Support Tickets' => [
                'FriendlyName' => 'Create Support Tickets',
                'Type' => 'yesno',
                'Description' => 'Automatically create support tickets when phishing incidents are detected',
            ],
        ]
    ];
}
 ...
 */
function scantra_phishing_detection_activate()
{
 ...
 * @return array Optional success/failure message
 */
function scantra_phishing_detection_deactivate()
{
 ...
 * @return void
 */
function scantra_phishing_detection_upgrade($vars)
{
 ...
 * @return string
 */
function scantra_phishing_detection_output($vars)
{
    ...
    $enableDomainTracking = $vars['Enable Domain Tracking'];
    $autoSuspendDomains = $vars['Auto Suspend Domains'];
    $createSupportTickets = $vars['Create Support Tickets'];
 ...
 * @return string
 */
function scantra_phishing_detection_sidebar($vars)
{
    // Get common module parameters
 ...
 * @return array
 */
function scantra_phishing_detection_clientarea($vars)
{
    // Get common module parameters
